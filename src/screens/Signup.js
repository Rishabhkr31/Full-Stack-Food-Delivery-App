...
export default function Signup() {
  ...
  return (
    <div style={{ backgroundImage: 'url("https://img.freepik.com/premium-photo/italian-food-with-ingredients_1220-4856.jpg?size=626&ext=jpg&ga=GA1.1.1869007374.1686813475&semt=ais")', backgroundSize: 'cover',height: '100vh' }}>
      <div>
      <Navbar />
      </div>

        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-dark border-white rounded' onSubmit={handleSubmit}>
            <div className="m-3">
